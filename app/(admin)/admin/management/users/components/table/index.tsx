...
import DataTableActionsOnSelected from "@/app/(admin)/admin/management/users/components/table/actionsOnSelected";
import TableFilters from "@/app/(admin)/admin/management/users/components/table/filters";
...
export function AdminUserTable<TData, TValue>({
  columns,
  data,
  showActions = true,
